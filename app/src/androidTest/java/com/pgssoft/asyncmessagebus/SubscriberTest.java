...
public class SubscriberTest extends InstrumentationTestCase {
    ...
    public void testConstructorAndHashCode() throws Exception {
        ...
        try {
            ...
            new Subscriber(null, method);
            fail("Should have throw");
        } catch (Throwable ignored) {
        }
        try {
            //noinspection ConstantConditions
            new Subscriber(testTarget1, null);
            fail("Should have throw");
        } catch (Throwable ignored) {
        }
    ...
    public void testEquality() throws Exception {
        ...
        Subscriber subject_1_1 = new Subscriber(testTarget1, method1);
        Subscriber subject_1_2 = new Subscriber(testTarget1, method2);
        Subscriber subject_2_1 = new Subscriber(testTarget2, method1);
        Subscriber subject_2_2 = new Subscriber(testTarget2, method2);

        Subscriber secondSubject_1_1 = new Subscriber(testTarget1, method1);
